(function() {
  ...
  document.addEventListener('DOMContentLoaded', function() {
    ...
    wsUrl += document.location.host + '/hterm-ws' + location.pathname;
  ...
  Terminal = (function() {
    ...
    Terminal.prototype.keyDown = function(ev) {
      ...
      // copy/paste
      if ((ev.ctrlKey || ev.metaKey) && (ev.charCode == 67 || ev.key === 'c' || ev.charCode == 86 || ev.key === 'v')) {
        return true;
      }
      // ctrl + s save
